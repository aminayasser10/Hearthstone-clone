...
public class minionspells {
	...
	public static void display(Hero cur, Hero opphero, Card c) {
		...
		BackgroundImage bg = new BackgroundImage(
				new Image("file:herospell.png"), BackgroundRepeat.NO_REPEAT,
		...
		if (oppfield1.isVisible()) {
			oppfield1.setOnMouseClicked(e2 -> {
				Minion m = opphero.getField().get(0); sound2();
				try {
					cur.castSpell(s, m);
		...
		if (oppfield2.isVisible()) {
			oppfield2.setOnMouseClicked(e2 -> {
				Minion m = opphero.getField().get(1);sound2();
				try {
					cur.castSpell(s, m);
				} catch (NotEnoughManaException e1) {
					AlertMana.display();
		...
		if (oppfield3.isVisible()) {
			oppfield3.setOnMouseClicked(e2 -> {
				Minion m = opphero.getField().get(2);sound2();
				try {
					cur.castSpell(s, m);
				} catch (NotEnoughManaException e1) {
					AlertMana.display();
		...
		if (oppfield4.isVisible()) {
			oppfield4.setOnMouseClicked(e2 -> {
				Minion m = opphero.getField().get(3);sound2();
				try {
					cur.castSpell(s, m);
				} catch (NotEnoughManaException e1) {
					AlertMana.display();
		...
		if (oppfield5.isVisible()) {
			oppfield5.setOnMouseClicked(e2 -> {
				Minion m = opphero.getField().get(4);sound2();
				try {
					cur.castSpell(s, m);
				} catch (NotEnoughManaException e1) {
					AlertMana.display();
		...
		if (oppfield6.isVisible()) {
			oppfield6.setOnMouseClicked(e2 -> {
				Minion m = opphero.getField().get(5);sound2();
				try {
					cur.castSpell(s, m);
				} catch (NotEnoughManaException e1) {
					AlertMana.display();
		...
		if (oppfield7.isVisible()) {
			oppfield7.setOnMouseClicked(e2 -> {
				Minion m = opphero.getField().get(6);sound2();
				try {
					cur.castSpell(s, m);
				} catch (NotEnoughManaException e1) {
					AlertMana.display();
